...
mod tests {
    ...
    use exca::models::{Direction, Moves, Position, m_Moves, m_Position};
    use exca::systems::actions::{IActionsDispatcher, IActionsDispatcherTrait, actions};
    ...
    fn contract_defs() -> Span<ContractDef> {
        [
            ContractDefTrait::new(@"exca", @"actions")
                .with_writer_of([dojo::utils::bytearray_hash(@"exca")].span())
        ]
            .span()
    }
